...
public class UserMainUI extends JFrame {
    ...
    public UserMainUI() {
        ...
        // 전체 메뉴 목록
        allMenus = List.of(
                new common.Menu("menu001", "아메리카노", 3000, "cate001", Paths.get("common/src/main/resources/images/menu1.png"), "진한 에스프레소와 물", OptionGroup.loadOptionGroups("menu001")),
                new common.Menu("menu002", "카페라떼", 3500, "cate001", Paths.get("common/src/main/resources/images/menu2.png"), "에스프레소 + 스팀밀크", OptionGroup.loadOptionGroups("menu002")),
                new common.Menu("menu003", "바닐라라떼", 4000, "cate001", Paths.get("common/src/main/resources/images/menu3.png"), "바닐라향 가득한 라떼", OptionGroup.loadOptionGroups("menu003")),
                new common.Menu("menu004", "아이스티", 3000, "cate002", Paths.get("common/src/main/resources/images/menu4.png"), "상큼한 아이스티", OptionGroup.loadOptionGroups("menu004")),
                new common.Menu("menu005", "허브티", 3200, "cate002", Paths.get("common/src/main/resources/images/menu5.png"), "편안한 허브향", OptionGroup.loadOptionGroups("menu005"))
        );

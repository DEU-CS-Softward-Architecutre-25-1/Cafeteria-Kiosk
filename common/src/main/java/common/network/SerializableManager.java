...
public class SerializableManager {
    ...
    public static final Marker SERIALIZABLE_SENT_MARKER = CommonUtils.makeWithInitialization(MarkerFactory.getMarker("SERIALIZABLE_SENT"), marker -> marker.add(NETWORK_MARKER));
